...
def output_avg(dir):
	''' computes the average of a specific metric across multiple experiment results stored
	...
	for name in fileList:
		...
		avg_rs.append(temp_rs) # store the metric of interest from each experiment result file
